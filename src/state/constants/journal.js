...
export const SAVE_EDITED_DENTAL_VISIT = 'SAVE_EDITED_DENTAL_VISIT';
export const SET_SAVE_EDITED_DENTAL_VISIT = 'SET_SAVE_EDITED_DENTAL_VISIT';
export const DELETE_DENTAL_VISIT = 'DELETE_DENTAL_VISIT';
export const SET_DELETE_DENTAL_VISIT = 'SET_DELETE_DENTAL_VISIT';
