...
const DoctorProfile = props => {
	...
	const [ licenceImage ] = useState(
		doesUserProfileExists() && user.user_profile[0].license_img
	);
								...
								{showOfficeSection && (
									<View style={ styles.content }>
										<TextInputField
											...
											error={
												props.touched.office_name && props.errors.office_name
											}
										...
										<TextInputField
											...
											error={
												props.touched.office_address1 &&
												props.errors.office_address1
											}
											secureTextEntry={ false }
										/>
										<TextInputField
											...
											error={
												props.touched.office_address2 &&
												props.errors.office_address2
											}
											secureTextEntry={ false }
										/>
										<TextInputField
											...
											error={
												props.touched.office_tax_id &&
												props.errors.office_tax_id
											}
											secureTextEntry={ false }
										/>
										<TextInputField
								...
								{showPersonalSection && (
									<View style={ styles.content }>
										...
										<TextInputField
											...
											error={
												props.touched.licence_no && props.errors.licence_no
											}
											secureTextEntry={ false }
										/>
										<TextInputField
											...
											error={
												props.touched.license_exp_date &&
												props.errors.license_exp_date
											}
											secureTextEntry={ false }
										/>
								...
								{showBankSection && (
									<View style={ styles.content }>
										<TextInputField
											...
											error={
												props.touched.routing_number &&
												props.errors.routing_number
											}
											secureTextEntry={ false }
										/>
										<TextInputField
										...
										<TextInputField
											...
											error={
												props.touched.confirm_account_no &&
												props.errors.confirm_account_no
											}
											secureTextEntry={ false }
										/>
									</View>
